...
(function () {
  ...
  const en = {
    ...
    about: {
      ...
      p2: "My background is computational: Monte Carlo simulation of the two-dimensional Ising model, crystal lattice simulations, statistical analysis of radioactive decay data, and a machine learning pipeline that predicts semiconductor band gaps from atomic descriptors. This project applies the same habits to energy strategy. Sourced data, reproducible analysis, and models whose assumptions are written down where everyone can check them.",
  ...
  const de = {
    ...
    about: {
      ...
      p2: "Mein Hintergrund ist rechnerisch: Monte-Carlo-Simulation des zweidimensionalen Ising-Modells, Kristallgitter-Simulationen, statistische Auswertung radioaktiver Zerfallsdaten und eine Machine-Learning-Pipeline, die Halbleiter-Bandlücken aus Atomdeskriptoren vorhersagt. Dieses Projekt überträgt dieselben Gewohnheiten auf Energiestrategie. Belegte Daten, reproduzierbare Analysen und Modelle, deren Annahmen dort stehen, wo jeder sie prüfen kann.",
